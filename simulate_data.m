...
data_time_points = [12]; %the times at which we will collect/simulate data
D = zeros(1,numel(data_time_points));
...
D(:,k) = [c+d]; %c+d corresponds to data where we can distinguish only between neuroblasts and other cells
end
